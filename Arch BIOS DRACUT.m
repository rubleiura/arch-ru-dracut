...
clear
#------------------------------------------------------------------------------
# ШАГ 1: БАЗОВЫЕ УТИЛИТЫ И ПАКЕТЫ (ОБЯЗАТЕЛЬНО ДЛЯ ВСЕХ)
#------------------------------------------------------------------------------
# 📦 mesa/lib32-mesa : Основа графического стека.
# 📦 vulkan-tools/libva-utils/mesa-utils : Диагностика.
pacman -Sy --noconfirm mesa lib32-mesa vulkan-tools libva-utils mesa-utils mesa-demos glmark2
#------------------------------------------------------------------------------
# ШАГ 2: ВЫБОР СЦЕНАРИЯ ВИДЕО
#------------------------------------------------------------------------------
# >>> [СЦЕНАРИЙ А] INTEL <<<
...
#------------------------------------------------------------------------------
# ℹ️ Для Intel/AMD: Применяются общие настройки KMS.
...
# ✅ ИСПРАВЛЕНО: Явное указание образа для гарантии обновления LTS.
# dracut --force /boot/initramfs-linux-lts.img
