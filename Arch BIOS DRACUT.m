...
# pacman -Sy --noconfirm intel-vulkan-driver
...
# 📦 Включает: Plasma, Dolphin, Konsole, Kate, SDDM, порталы, мультимедиа.
#------------------------------------------------------------------------------
# 🧹 Очистка экрана терминала
clear
...
# 📦 Кодеки, интеграция и порталы Wayland/XDG (критично для скриншотов и диалогов)
pacman -Sy --noconfirm ffmpegthumbs poppler-glib packagekit packagekit-qt6 xdg-desktop-portal xdg-desktop-portal-kde
# 📦 Мультимедиа и просмотр изображений с поддержкой HEIC/WebP/AVIF (официальные репозитории)
pacman -Sy --noconfirm mpv shotwell
# 📦 GVFS для монтирования устройств и сетевых дисков (SMB/NFS/Google/OneDrive/MTP)
...
# 📦 PackageKit и порталы Wayland/XDG
pacman -Sy --noconfirm packagekit packagekit-qt6 gnome-packagekit xdg-desktop-portal xdg-desktop-portal-gnome
# 📦 Мультимедиа и просмотр изображений (HEIC/WebP/AVIF)
pacman -Sy --noconfirm ffmpegthumbnailer poppler-glib mpv shotwell
...
# 📦 Порталы Wayland/XDG и мультимедиа (HEIC/WebP/AVIF + видео)
pacman -Sy --noconfirm xdg-desktop-portal xdg-desktop-portal-gtk ffmpegthumbnailer poppler-glib mpv shotwell xdg-user-dirs
# 📦 GVFS для монтирования устройств и сетевых дисков
pacman -Sy --noconfirm gvfs gvfs-afc gvfs-dnssd gvfs-goa gvfs-gphoto2 gvfs-mtp gvfs-nfs gvfs-onedrive gvfs-smb gvfs-wsdd
...
# 📦 Сетевые апплеты
pacman -Sy --noconfirm network-manager-applet blueman
# 📦 Порталы Wayland/XDG и мультимедиа
pacman -Sy --noconfirm xdg-desktop-portal xdg-desktop-portal-gtk ffmpegthumbnailer poppler-glib mpv shotwell
# 📦 GVFS для монтирования устройств и сетевых дисков
pacman -Sy --noconfirm gvfs gvfs-afc gvfs-dnssd gvfs-goa gvfs-gphoto2 gvfs-mtp gvfs-nfs gvfs-onedrive gvfs-smb gvfs-wsdd
# 📦 Дисплейный менеджер LightDM
pacman -Sy --noconfirm lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings
...
pacman -Sy --noconfirm network-manager-applet blueman
# 📦 Порталы Wayland/XDG и мультимедиа
pacman -Sy --noconfirm xdg-desktop-portal xdg-desktop-portal-gtk ffmpegthumbnailer poppler-glib mpv shotwell gnome-themes-extra
# 📦 Дисплейный менеджер LightDM
pacman -Sy --noconfirm lightdm lightdm-slick-greeter
# 📋 Настройка LightDM на Slick Greeter
