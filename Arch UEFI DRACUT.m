...
echo " "
# 💡 ОБЯЗАТЕЛЬНО:
# После разметки проверьте, что разделы sda1, sda2, sda3 соответствуют вашему диску.
...
# 📦 memtest86+-efi — тест оперативной памяти (~2 МБ)
...
grub-install --target=x86_64-efi --efi-directory=/boot --bootloader-id="Grub Arch Linux"
#------------------------------------------------------------------------------
