...
sed -i "s|^[[:space:]]*#\?GRUB_CMDLINE_LINUX=.*|GRUB_CMDLINE_LINUX=\"rd.luks.uuid=${CRYPT_UUID} rd.lvm.lv=vg_main/lv_root rd.lvm.lv=vg_main/lv_swap root=UUID=${ROOT_UUID} rootflags=subvol=@ resume=UUID=${SWAP_UUID}\"|" /etc/default/grub
